...
function link(){
	var url = "<%=basePath %>/files/addCustomer.jsp";
	//alert(url)
	window.location=url;
}
          			...
          			<td>
              			...
              			<tr>
                			<td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
								<tr>
                    				<td height="20" style="text-align:center;" colspan="11" align="center" bgcolor="#EEEEEE" class="tablestyle_title">客户记录列表</td>
                    			</tr>
                  				<tr>
				                    ...
				                    <td width="4%" align="center" bgcolor="#EEEEEE">姓别</td>
				                    ...
				                    <td width="11%" align="center" bgcolor="#EEEEEE">采样师编号</td>
				                    <td width="11%" align="center" bgcolor="#EEEEEE">采样师</td>
				                    <td width="11%" align="center" bgcolor="#EEEEEE">采样日期</td>
                  				</tr>
<%
while(ret.next()) {
