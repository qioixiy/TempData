...
*/
		...
		retOut.intensityL1 = GetAffinityValue(retOut.intensityL1); // 强度
		retOut.intensityL2 = GetAffinityValue(retOut.intensityL2);
		retOut.intensityL3 = GetAffinityValue(retOut.intensityL3);
		retOut.intensityL4 = GetAffinityValue(retOut.intensityL4);
		retOut.intensityL5 = GetAffinityValue(retOut.intensityL5);
		retOut.intensityR1 = GetAffinityValue(retOut.intensityR1);
		retOut.intensityR2 = GetAffinityValue(retOut.intensityR2);
		retOut.intensityR3 = GetAffinityValue(retOut.intensityR3);
		retOut.intensityR4 = GetAffinityValue(retOut.intensityR4);
		retOut.intensityR5 = GetAffinityValue(retOut.intensityR5);
		retOut.LeftBrain = GetAffinityValue(retOut.LeftBrain);// 左脑
		retOut.RightBrain = GetAffinityValue(retOut.RightBrain);// 右脑
		retOut.reason1 = GetAffinityValue(retOut.reason1);// 理性
		retOut.reason2 = GetAffinityValue(retOut.reason2);
		retOut.reason3 = GetAffinityValue(retOut.reason3);
		retOut.reason4 = GetAffinityValue(retOut.reason4);
		retOut.reason5 = GetAffinityValue(retOut.reason5);
		retOut.Sensibility1 = GetAffinityValue(retOut.Sensibility1);// 感性
		retOut.Sensibility2 = GetAffinityValue(retOut.Sensibility2);
		retOut.Sensibility3 = GetAffinityValue(retOut.Sensibility3);
		retOut.Sensibility4 = GetAffinityValue(retOut.Sensibility4);
		retOut.Sensibility5 = GetAffinityValue(retOut.Sensibility5);
		retOut.motivation = GetAffinityValue(retOut.motivation);// 动机
		retOut.Idea = GetAffinityValue(retOut.Idea);// 构思
		retOut.Visual = GetAffinityValue(retOut.Visual);// 视觉
		retOut.AuditorySense = GetAffinityValue(retOut.AuditorySense);// 听觉
		retOut.Somatosensory = GetAffinityValue(retOut.Somatosensory);// 体觉
